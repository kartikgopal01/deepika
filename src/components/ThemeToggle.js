...
const StyledWrapper = styled.div`
  ...
  .theme-switch {
    --toggle-size: 10px; /* Reduced from 30px for better navbar fit */
    ...
    /* Use theme colors that match the site's design */
  ...
  @media (max-width: 768px) {
    .theme-switch {
      --toggle-size: 16px; /* Slightly larger on mobile for better touch target */
    }
  }
